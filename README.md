[Overview](#overview) • [Installation](#installation) • [Dependencies](#dependencies) • [Screenshot](#screenshot)
...
Aa simple mobile web-based soundboard system with the ability to record your own sounds and play them on a remote (party) computer.
